...
export function Footer() {
	...
	return (
		<footer ref={ref} className="relative bg-multi-black text-white overflow-hidden isolate pb-4">
			{/* Grain Texture */}
			...
			<div
				className={cn(
					...
					isIntersecting ? "translate-y-10 scale-100" : "translate-y-32 scale-95",
				)}
			>
				<svg
					viewBox="0 0 200 200"
			...
			<div className="relative mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 z-10">
				<div className="grid grid-cols-1 gap-12 md:grid-cols-3">
					...
					>
						<Link href="/" aria-label="Multi BR — Página inicial" className="group">
							<Image
						...
						<p className="max-w-xs text-white/50 text-[15px] font-poppins leading-relaxed">
							Agência de marketing digital no Rio de Janeiro. Estratégia digital sem enrolação:
							presença, escala e vendas para quem quer resultado.
						</p>
						{/* Redes sociais */}
