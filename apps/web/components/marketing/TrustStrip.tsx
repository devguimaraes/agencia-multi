...
export function TrustStrip({ className }: { className?: string }) {
	...
	return (
		<section
			ref={ref}
			className={cn(
				"relative z-20 w-full bg-multi-amarelo py-6 md:py-8 overflow-hidden border-y-[3px] border-multi-roxo flex items-center transition-all duration-1000 shadow-[0_0_30px_rgba(255,183,1,0.3)]",
