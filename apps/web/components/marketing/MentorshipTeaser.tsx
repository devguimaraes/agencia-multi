          ...
          >
            ...
            <div className="space-y-3 text-[clamp(14px,1.5vw,18px)] leading-relaxed font-poppins text-multi-black/75">
              <p>
                ...
                é outra história. Proposta comercial, precificação,
                posicionamento, time — tudo isso precisa estar no lugar antes de
                escalar.
              </p>
              <p>
                Na Mentoria de Escala, você monta a operação que sustenta o
                crescimento. Sem achismo, com método validado por dezenas de
          ...
          >
            ...
            <div className="relative w-full max-w-[280px] md:max-w-[320px] aspect-9/16 rounded-3xl overflow-hidden shadow-2xl bg-multi-rosa">
              ...
              <div className="absolute top-8 left-3 right-3 flex items-center gap-2 z-30">
                ...
                <span className="font-poppins font-semibold text-white text-xs">
                  multi.br
                </span>
