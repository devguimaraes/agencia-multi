...
export function MentorshipTeaser({ className }: { className?: string }) {
  ...
  return (
    <section
      ref={ref}
      className={cn(
        "relative py-24 bg-multi-roxo text-white overflow-hidden",
        className,
      )}
    >
      {/* Brand Background Elements - Refined Visibility & Positioning */}
      <div className="absolute inset-0 pointer-events-none opacity-15 select-none overflow-hidden">
        {/* Logo Monocromática - Superior Esquerda (Restaurada e com brilho) */}
        <div className="absolute top-0 -left-10 w-[250px] md:w-[450px] h-auto -rotate-12">
          <Image
            src="/brand/logo-monocromatica.png"
            alt=""
            width={450}
            height={450}
            className="object-contain brightness-[5] contrast-100"
          />
        </div>

        {/* Ícone Branco - Superior Direita */}
        <div className="absolute -top-10 -right-10 w-[180px] md:w-[350px] h-auto rotate-12 blur-[0.5px]">
          <Image
            src="/brand/icone-branco-v2.png"
            alt=""
            width={350}
            height={350}
        ...
        {/* Ícone Branco - Inferior Esquerda (Substituindo a Logomarca) */}
        <div className="absolute -bottom-10 -left-10 w-[250px] md:w-[450px] h-auto -rotate-6">
          <Image
            src="/brand/icone-branco-v2.png"
            alt=""
            width={450}
        ...
        {/* Ícone Branco - Inferior Direita */}
        <div className="absolute -bottom-10 -right-10 w-[150px] md:w-[300px] h-auto rotate-12">
          <Image
            src="/brand/icone-branco-v2.png"
            alt=""
            width={300}
            ...
            >
              ...
              <ul className="space-y-6">
                {problems.map((prob) => (
                  <li
                    key={prob}
                    className="flex gap-4 items-start font-poppins text-lg"
                  >
