  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none z-0 overflow-hidden">
        ...
        <div
          className={cn(
            ...
            isIntersecting
              ? "opacity-20 scale-100 delay-500"
              : "opacity-0 scale-90",
          )}
        >
          <Image
        ...
        <div
          className={cn(
            ...
            isIntersecting
              ? "opacity-15 scale-100 delay-700"
              : "opacity-0 scale-90",
          )}
        >
          <Image
        ...
        <div
          className={cn(
            ...
            isIntersecting
              ? "opacity-20 scale-100 delay-900"
              : "opacity-0 scale-95",
          )}
        >
          <Image
      ...
      <div className="container mx-auto px-4 sm:px-6 max-w-6xl relative z-10 text-center">
        ...
        >
          Seja parceiro de resultados claros com estratégia sem enrolação. Não
          importa a sua fase, a Multi pode te ajudar.
        </p>
