				...
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
					{HIGHLIGHTS.map((item, idx) => (
						<div
							key={item.title}
							className={cn(
								"group relative aspect-square overflow-hidden rounded-xl border-4 cursor-pointer transition-transform duration-500 hover:scale-[1.02] border-multi-roxo opacity-0",
								item.bg,
