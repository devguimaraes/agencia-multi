...
const COLLAGE: readonly CollageItem[] = [
	...
	},
	{
		...
		alt: "Tucano tropical",
		position: "left-[3%] top-[5%] md:top-[10%] w-[100px] md:w-[15vw] max-w-[220px]",
		parallaxSpeed: -0.3,
		delay: 0.2,
		opacity: "opacity-80",
	},
	{
		...
		position: "left-[-8%] bottom-[-8%] md:bottom-[-4%] w-[250px] md:w-[40vw] max-w-[550px]",
		parallaxSpeed: -0.2,
		delay: 0.15,
		opacity: "opacity-90",
		rotate: "-rotate-6",
	},
	{
		...
		alt: "Caju",
		position: "left-[-1%] bottom-[-2%] md:bottom-[4%] w-[130px] md:w-[13vw] max-w-[200px]",
		parallaxSpeed: -0.35,
		delay: 0.25,
		opacity: "opacity-100",
		rotate: "rotate-[-10deg]",
	},
	{
		...
		alt: "Beija-flor",
		position: "right-[-2%] top-[5%] md:top-[10%] w-[130px] md:w-[15vw] max-w-[180px]",
		parallaxSpeed: -0.5,
		delay: 0.3,
		opacity: "opacity-100",
	},
...
export function HeroSection({ className }: { className?: string }) {
	...
	return (
		...
		>
			...
			{/* Conteúdo Principal */}
			<div ref={contentRef} className="w-full h-full relative z-20 pointer-events-none">
				<div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-5xl px-4 mt-20 md:mt-0 flex flex-col items-center text-center">
					{/* Logo centralizada */}
					<div ref={logoRef} className="mb-6 md:mb-8 will-change-transform" style={{ opacity: 0 }}>
						<Image
