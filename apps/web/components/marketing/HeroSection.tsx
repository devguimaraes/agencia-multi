...
export function HeroSection({ className }: { className?: string }) {
  ...
  return (
    ...
    >
      ...
      <div
        ref={contentRef}
        className="w-full h-full relative z-20 pointer-events-none flex items-center justify-center"
      >
        <div className="w-full max-w-5xl px-4 pt-24 pb-16 md:pt-0 md:pb-0 flex flex-col items-center text-center">
          {/* Logo centralizada */}
          <div
            ref={logoRef}
          ...
          >
            ...
            <Magnetic strength={0.3} radius={60}>
              <a
                href="#contato"
                className="group relative overflow-hidden bg-multi-amarelo text-multi-roxo font-poppins font-bold text-sm md:text-lg px-6 py-3 md:px-10 md:py-5 rounded-sm border-none shadow-xl flex items-center justify-center gap-2"
              >
            ...
            <Magnetic strength={0.2} radius={50}>
              <a
                href="#servicos"
                className="group relative text-white font-poppins font-semibold text-sm md:text-lg px-6 py-3 md:px-10 md:py-5 rounded-sm border-2 border-white/80 hover:border-white hover:bg-white/10 hover:shadow-lg transition-all duration-300 flex items-center justify-center"
              >
