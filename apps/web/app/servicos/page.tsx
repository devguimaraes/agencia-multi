...
export const metadata: Metadata = {
  ...
  description:
    "Conheça nossas soluções em Marketing Digital, Tráfego Pago e Branding.",
};
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 md:gap-16">
            ...
            <RevealSection delay className="max-w-md pb-2">
              <p className="font-poppins text-lg md:text-xl text-white/70 leading-relaxed border-l-2 border-multi-amarelo/50 pl-6">
                Estratégias completas para posicionar sua marca, engajar sua
                audiência e escalar suas vendas sem enrolação.
              </p>
            </RevealSection>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 relative z-10 text-center flex flex-col items-center">
          ...
          <RevealSection delay>
            <p className="font-poppins text-lg text-white/80 max-w-xl mx-auto mb-10">
              Cada negócio é único. Conte-nos seu desafio e criaremos um plano
              de ataque específico para você.
            </p>
          </RevealSection>
