			...
			<section className="bg-multi-roxo text-white py-20 md:py-32 relative overflow-hidden">
				...
				<div className="container mx-auto px-4 relative z-10 text-center">
					...
					<p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto opacity-90 animate-fade-in-up stagger-1">
						Mentoria exclusiva para profissionais que querem sair do operacional e focar na
						estratégia e vendas.
					</p>
					<Button
						asChild
						size="lg"
						className="bg-multi-amarelo text-multi-roxo hover:bg-white hover:text-multi-roxo font-bold text-lg px-8 py-6 h-auto animate-fade-in-up stagger-2"
					>
				...
				<div className="container mx-auto px-4">
					...
					<div className="grid md:grid-cols-3 gap-8">
						{[
							...
							<Card
								key={item}
								className="bg-red-50 border-none animate-fade-in-up"
				...
				<div className="container mx-auto px-4">
					...
					<div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
						{[
							...
							<div
								key={mod}
								className="flex items-center gap-4 bg-white p-6 rounded-xl shadow-sm animate-fade-in-up"
								style={{ animationDelay: `${idx * 100}ms` }}
							>
			...
			<section className="py-20 bg-multi-roxo text-white text-center">
				<div className="container mx-auto px-4">
					...
					<Button
						asChild
						size="lg"
						className="bg-multi-amarelo text-multi-roxo hover:bg-white hover:text-multi-roxo font-bold animate-fade-in-up stagger-1"
					>
