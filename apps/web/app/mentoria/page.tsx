...
export const metadata: Metadata = {
  ...
  description:
    "Acelere o crescimento da sua agência ou carreira como Social Media.",
};
        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10 flex flex-col items-center text-center max-w-5xl">
          ...
          <RevealSection delay>
            <p className="font-poppins text-lead text-white/80 max-w-2xl mx-auto mb-12">
              Mentoria exclusiva para profissionais que querem sair do
              operacional, lotar a agenda e estruturar um negócio escalável.
            </p>
          </RevealSection>
              ...
              <div className="sticky top-32">
                <RevealSection>
                  ...
                  <p className="font-poppins text-lg text-gray-600">
                    Se você trabalha muito, ganha pouco e sente que a agência
                    não cresce, o problema não é falta de esforço. É falta de{" "}
                    <strong>processo e posicionamento</strong>.
                  </p>
                </RevealSection>
              </div>
            </div>
