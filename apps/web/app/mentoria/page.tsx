...
import { CheckCircle2, LineChart, Target, TrendingUp, Users, Wallet } from "lucide-react";
import type { Metadata } from "next";
import Image from "next/image";

export const metadata: Metadata = {
	title: "Mentoria para Social Media | Saia do Freelancer para Agência | Multi BR",
	description:
				...
				<div className="container mx-auto px-4 sm:px-6 relative z-10 flex flex-col items-center text-center max-w-5xl">
					...
					<RevealSection delay>
						<p className="font-poppins text-lead text-white/80 max-w-2xl mx-auto mb-12">
							...
							estrutura. Mentoria prática para Social Medias que querem montar uma agência com
							equipe, processo e ticket acima de R$&nbsp;10k/mês.
						</p>
					</RevealSection>
					...
					<div className="grid lg:grid-cols-12 gap-16 lg:gap-24">
							...
							<div className="sticky top-32">
								<RevealSection>
									...
									<p className="font-poppins text-xl text-white/60 leading-relaxed border-l-2 border-multi-rosa/50 pl-6">
										Social Media que faz tudo sozinho não tem agência — tem um emprego disfarçado. O
										problema não é dedicação. É que você nunca aprendeu a montar{" "}
						...
						<div className="lg:col-span-7">
							<StaggerContainer className="flex flex-col border-t border-white/10 mt-10 lg:mt-0">
								{[
									{
										title: "Você é designer, copy, analista e atendimento ao mesmo tempo",
									...
									{
										title: "Seus clientes pagam R$ 800, R$ 1.500. E acham caro.",
				...
				<div className="container mx-auto px-4 relative z-10 text-center flex flex-col items-center">
					...
					<RevealSection delay>
						...
						<p className="font-poppins text-sm text-white/40 mt-6 max-w-xs mx-auto text-center leading-relaxed">
							Últimas vagas para acompanhamento próximo. Sem promessa de milagre — só método que
							funciona.
						</p>
					</RevealSection>
				</div>
