        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20">
            ...
            <div className="space-y-12 animate-fade-in-up">
              <div>
                <h2 className="font-display text-2xl text-multi-roxo mb-6">Informações de Contato</h2>
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a href="mailto:contato@agenciamultibr.com" className="text-gray-600 hover:text-multi-roxo transition-colors">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a href="https://wa.me/5521999999999" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-multi-roxo transition-colors">
                        (21) 99999-9999
                      </a>
                    </div>
                  </div>
              ...
              <div>
                 ...
                 <div className="flex gap-4">
                   <a href="#" className="w-12 h-12 bg-gray-100 rounded-full flex items-center justify-center text-gray-600 hover:bg-multi-roxo hover:text-white transition-all">
